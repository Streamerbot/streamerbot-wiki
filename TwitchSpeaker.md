...
## Settings
- [<i class="mdi mdi-application text--twitch"></i>**UDP Interface*You can run TwitchSpeaker stuff trough Streamer.bot***](/en/TwitchSpeaker/Tabs/Settings/General){.disabled}
