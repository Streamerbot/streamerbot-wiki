...
- [<i class="mdi mdi-adjust"></i> **Enable/Disable all Channel Points *Enable or Disable all of your channel points***](/en/Quick-Start/Examples/Enable-Disable-Channel-Points){.disabled}
{.btn-grid .my-5}
