...
- [<i class="mdi mdi-launch"></i> **Activate Actions When streamer.bot launches *Learn how to have actions run when your streamer.bot starts up***](/en/Quick-Start/Example/steamerbot-launch){.disabled}
