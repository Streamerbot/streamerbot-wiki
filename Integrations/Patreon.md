...
> On patreon the **upper 3 events** should be turned **off** because they're deprecated, and the **bottom 6 events** with `members:*` should be turned **on**.
{.is-warning}

![patreon-integration.png](/patreon-integration.png)

## Variables
Variables where updated in *v0.1.15*{.version-badge} to be all camelCase.
