...
* [<i class="mdi mdi-account text--twitch"></i>**Follow Mode *Toggle follower mode*** *v0.1.15*{.version-badge}](/Sub-Actions/Twitch/Follow-Mode){.disabled}
