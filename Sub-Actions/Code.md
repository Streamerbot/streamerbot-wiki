...
- [<i class="mdi  primary--text"></i> **Variable Types *A list of all available variable types that you can import in to your code***](/en/Sub-Actions/Code/Execute-CSharp-Code/Variables)
{.btn-grid .my-5}
