...
- [<i class="mdi mdi-variable-box primary--text"></i> **Variable Types *A list of all available variable types that you can import in to your code***](/en/Sub-Actions/Code/CSharp/Streamerbot-Variables)
{.btn-grid .my-5}
