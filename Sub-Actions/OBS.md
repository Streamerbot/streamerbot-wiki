...
* [<i class="mdi mdi-format-paint text--obs"></i>**Set Color Source Color *Set a HEX or random color for a color source with v0.1.14 *v0.1.14*{.version-badge}***](/Sub-Actions/OBS/Set-Color-Source-Color){.disabled}
{.btn-grid .my-5}
