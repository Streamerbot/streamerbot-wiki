...
* [<i class="mdi mdi-format-paint text--obs"></i>**Set Color Source Color *Set a heximal or random color for a color source *v0.1.13*{.version-badge}***](/Sub-Actions/OBS/Set-Color-Source-Color){.disabled}
{.btn-grid .my-5}
