...
* [<i class="mdi mdi-connection text--obs"></i>**Get Status *Get your Connection, Streaming and Recording status***](/Sub-Actions/OBS/Get-Status)
{.btn-grid .my-5}
...
* [<i class="mdi mdi-format-paint text--obs"></i>**Set Color Source Color *Set a hex or random color for a color source***](/Sub-Actions/OBS/Set-Color-Source-Color)
{.btn-grid .my-5}
...
- [<img src="https://streamer.bot/img/integrations/streamlabs.png"/> **Streamlabs Desktop *Using Streamlabs Desktop instead? Click here!***](/Sub-Actions/Streamlabs-Desktop)
{.btn-grid .my-5}